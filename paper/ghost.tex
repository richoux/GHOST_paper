...
\begin{abstract}
  ...
  selection problen, the wall-ion problem and the build order planning
...
is called  a {\it configuration}.   Since \csp/\cop models  a specific
problem $\mathcal{P}$,  a \csp/\cop formula represents  an instance of
$\mathcal{P}$.
...
showing   a   heuristic   search   method   making   combats   outcome
predictions.  These two  last  papers  are also  among  the rare  ones
dealing with the target selection problem in StarCraft.
...
Synnaeve\footnote{\href{http://emotion.inrialpes.fr/people/synnaeve/TLGGICCUP\_gosu\_reps.7z}{http://emotion.inrialpes.fr/people/synnaeve/TLGGICCUP\_gosu\_reps.7z}}
and refined by Glen Robertson\footnote{\href{}{}}, and those extracted from top
Korean pro-gamers.
