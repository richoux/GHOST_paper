...
\begin{table*}[tba]
  \label{tbl:bo}
  \centering
  \caption{Average makespan in seconds of Human and \ghost build orders over 5269
    games. \ghost has been run 10 times on each game.}
  \begin{tabular}{|l|c|c|c||c|c|} 
    \cline{3-6}
    \multicolumn{2}{c|}{ } &\multicolumn{4}{c|}{\ghost} \\ 
    \hline
    {\em Match-up} & Humans & Timings in \cite{ChurchillB11} &
    Gain (Human - \ghost) & Strict
    timings & Gain (Human - \ghost)\\ 
    \hline
    {\em All} & 461.77 & 464.49 & -3.15 & 469.57 & -8.19\\
    {\em PvP} & 463.09 & 465.51 & -2.86 & 470.40 & -7.71\\
    {\em PvT} & 471.24 & 482.21 & -11.36 & 486.55 & -15.65\\
    {\em PvZ} & 449.97 & 443.02 & 6.49 & 449.04 & 0.49\\ 
    \hline
  \end{tabular}  
\end{table*}
