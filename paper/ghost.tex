...
\ghost is a combinatorial  optimization framework designed to tackle real-time problems, helping a programmer to model his/her problem and to solve it using the inner solver, without parameter tuning needed or advanced knowledge on constraint programming. RTS games contain many real-time combinatorial optimization problems that can be modeled and solved via a constraint programming framework. Before introducing models and results for several problems related to RTS games, we give in the next section the basis of combinatorial  optimization problems.
