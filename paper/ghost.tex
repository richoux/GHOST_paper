...
time the full state of the game.
...
rather than second, to not make any confusions with regular seconds.
...
the same averages when the opponent wins.
...
\begin{table*}[ht]
  \caption{Average  makespan  of Humans  and  \ghost  build orders  in
    StarCraft unit time over 3647 games.}
  \label{tab:bo}
  \centering
...
above, we  parameterized our  simulator as  follow (in  StarCraft unit
time):
%--------------
\begin{itemize}
