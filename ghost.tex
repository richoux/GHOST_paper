...
\begin{abstract}
  ...
  \emph{strategy} problem). In our experiments, \ghost shows good
  results computed within some tens of milliseconds. We also show that
  \ghost outperforms state-of-the-art constraint solvers,
  matching them on the resources allocation problem, a common combinatorial optimization problem.
\end{abstract}
...
the domain  is smaller and the rules  are easier and less  numerous, thus
...
current situation,  and then make  a decision. This is  especially true
...
with Real-Time Strategy (RTS) games, where a Clausewitz's  fog of war
hides  the opponent's  moves.  \minormod{Hence,  RTS games are a good domain for testing
 Artificial  Intelligence (AI) techniques  that  could  be  applied
...
%Only  problem models  will, of course, differ.

\subsection{StarCraft: Brood War}

StarCraft:  Brood War  is 
% the  expansion of  the game  StarCraft, both
% released in 1998  by Blizzard Entertainment.  It is 
an  RTS game where
...
% 1 regular second = 1.59477562 SC second
...
% This is true in particular for RTS games where AI is a capital part of the game but its real-time aspect and numerous agent interactions  leave some tens of milliseconds only to solve a problem.
%Although some problems can be solved within a couple of frames, taking then hundreds of milliseconds of CPU time without any issue, this is not the case in general: problems like target selection or path-finding need a solution within one frame.
...
\item \textbf{Meta-heuristics},  also called incomplete algorithms,  
  ...
  %the only viable  methods   to  manage   
...
% It means that, if after $x$ $\mu s$, we leave the satisfaction loop, certainly without a valid solution since the loop stops as soon as it finds a solution. 
...
\begin{tabular}{@{}l*{3}{S[table-format=3]}@{}} 
 \toprule 
 & \multicolumn{3}{c}{\textbf{Damage Type}} \\
\cmidrule(l){2-4}
...
\begin{tabular}{@{}clSSSSSSS[table-format=2.1]@{}} 
 \toprule 
\multicolumn{5}{c}{} & \multicolumn{2}{c}{\textbf{\ghost Victory}} & \multicolumn{2}{c}{\textbf{Opponent Victory}}\\
\cmidrule(lr){6-7} \cmidrule(l){8-9}
\multicolumn{1}{c}{} & \multicolumn{1}{c}{\textbf{Objective}} & \multicolumn{1}{c}{\textbf{Wins}} & \multicolumn{1}{c}{\textbf{Draws}} & 
\multicolumn{1}{c}{\textbf{Loses}} & \multicolumn{1}{c}{\textbf{\# Avg. living units}} & \multicolumn{1}{c}{\textbf{Avg. HP}} & 
\multicolumn{1}{c}{\textbf{\# Avg. living units}} & \multicolumn{1}{c}{\textbf{Avg. HP}}\\
\midrule
\multicolumn{1}{c}{\multirow{2}{*}{\rotatebox[origin=c]{90}{\textbf{3~ms}}}} 
& {\em Max Damage} & 98 & 1 & 1 & 2.8 & 237.9 & 1.0 & 12.0\\
& {\em Max Kill}   & 94 & 5 & 1 & 3.0 & 250.8 & 1.0 & 3.0\\
\midrule
\multicolumn{1}{c}{\multirow{2}{*}{\rotatebox[origin=c]{90}{\textbf{5~ms}}}} 
& {\em Max Damage} & 99 & 1 & 0 & 2.6 & 231.9 & 0.0 & 0.0\\
& {\em Max Kill}   & 96 & 4 & 0 & 2.6 & 233.6 & 0.0 & 0.0\\
\bottomrule
\end{tabular}
...
\begin{tabular}{@{}SSSS@{}} 
 \toprule 
\multicolumn{1}{l}{\begin{tabular}[c]{@{}l@{}}\textbf{Chokepoint}\\ \textbf{width (pixels)}\end{tabular}} & \multicolumn{1}{l}{\begin{tabular}[c]{@{}l@{}}\textbf{Buildings}\\ \textbf{needed}\end{tabular}} & \multicolumn{1}{l}{\begin{tabular}[c]{@{}l@{}} \textbf{\ghost} \\ \textbf{Avg. time (ms)}\end{tabular}} & \multicolumn{1}{l}{\begin{tabular}[c]{@{}l@{}}\textbf{Clingo}\\ \textbf{Avg. time (ms)}\end{tabular}} \\
\midrule
65  & 2 & 46.8 & 362.8 \\
250 & 2 & 33.5 & 408.8 \\
\bottomrule
...
\caption{Our simulator execution matched  against the pro-gamer Bisu
    during the first 1900 frames (\ie, 80 seconds)}
\label{tab:korean}
\begin{tabular}{@{}lS[table-format=4]S[table-format=2.1]cS[table-format=3]c@{}} 
 \toprule 
\multicolumn{2}{c}{} & \multicolumn{2}{c}{\textbf{Simulator in \ghost}} & \multicolumn{2}{c}{\textbf{Bisu}}\\
\cmidrule(lr){3-4} \cmidrule(l){5-6}
\multicolumn{1}{l}{\textbf{Action}} & \multicolumn{1}{c}{\textbf{Frames}} & \multicolumn{1}{c}{\textbf{Mineral}} & \multicolumn{1}{c}{\textbf{Supply (Used/Capacity)}} & \multicolumn{1}{c}{\textbf{Mineral}} & \multicolumn{1}{c}{\textbf{Supply (Used/Capacity)}}\\
\midrule
...
Simulator starts a pylon   & 1119 & \multicolumn{1}{c}{-} & \multicolumn{1}{c}{-} & \multicolumn{1}{c}{-} & \multicolumn{1}{c}{-} \\
Bisu starts a pylon        & 1164 & \multicolumn{1}{c}{-} & \multicolumn{1}{c}{-} & \multicolumn{1}{c}{-} & \multicolumn{1}{c}{-} \\
Simulator starts a probe   & 1328 & 1.2                   & 9/9                   & 12                    & 9/9\\
Simulator starts a probe   & 1627 & 60.0                  & 10/17                 & 132                   & 9/17\\
Bisu starts a gateway      & 1731 & \multicolumn{1}{c}{-} & \multicolumn{1}{c}{-} & \multicolumn{1}{c}{-} & \multicolumn{1}{c}{-} \\
Simulator starts a gateway & 1866 & \multicolumn{1}{c}{-} & \multicolumn{1}{c}{-} & \multicolumn{1}{c}{-} & \multicolumn{1}{c}{-} \\
Simulator starts a probe   & 1866 & 1.8                   & 11/17                 & 78                    & 9/17\\
\bottomrule
\end{tabular}
\end{table*}
% 
...
\begin{table*}[ht]
  ...
  \label{tab:bo}
  \centering
  \begin{tabular}{lS[table-format=4]S[table-format=4]S[table-format=2.1]S[table-format=3]}
    \toprule
    \multicolumn{5}{c}{\textbf{Games till 10,000 frames}} \\
    \cmidrule{1-5}
    \multicolumn{1}{l}{\textbf{Match-up}} & \multicolumn{1}{l}{\textbf{Humans}} & \multicolumn{1}{l}{\textbf{\ghost}} & 
    \multicolumn{1}{l}{\textbf{\% Solved}} & \multicolumn{1}{l}{\textbf{Gain}} \\
    \midrule
    {\em All} & 9794 & 9250 & 94.4 & 544\\
    {\em PvP} & 9727 & 9078 & 95.0 & 649\\
    {\em PvT} & 9861 & 9378 & 93.9 & 483\\
  ...
  \begin{tabular}{lS[table-format=4]S[table-format=4]S[table-format=2.1]S[table-format=3]}
    \toprule
    \multicolumn{5}{c}{\textbf{Games till 7,800 frames}} \\
    \cmidrule{1-5}
    \multicolumn{1}{l}{\textbf{Match-up}} & \multicolumn{1}{l}{\textbf{Humans}} & \multicolumn{1}{l}{\textbf{\ghost}} & 
    \multicolumn{1}{l}{\textbf{\% Solved}} & \multicolumn{1}{l}{\textbf{Gain}} \\
    \midrule
...
Zerg.   
%Replays are  coming from  TeamLiquid, GosuGamers and  ICCup web sites.  
...
\begin{tabular}{@{} 
    ...
    @{}} 
 \toprule 
 & & \multicolumn{1}{c}{\textbf{Opturion CPX}} & \multicolumn{1}{c}{\textbf{Gecode}} & \multicolumn{3}{c}{\textbf{\ghost} (100 runs)} & \multicolumn{3}{c}{\textbf{Oscar/CBLS} (10 runs)} \\
 \cmidrule(lr){3-3} \cmidrule(lr){4-4} \cmidrule(lr){5-7} \cmidrule(lr){8-10}
 & \multicolumn{1}{c}{\textbf{Optimal DPS}} & \multicolumn{1}{c}{\textbf{Runtime}} & \multicolumn{1}{c}{\textbf{Runtime}} & \multicolumn{1}{c}{\textbf{\% Opt. Found}} & \multicolumn{1}{c}{\textbf{Mean DPS}} & \multicolumn{1}{c}{\textbf{Runtime}} & \multicolumn{1}{c}{\textbf{Mean DPS}} & \multicolumn{1}{c}{\textbf{Best DPS}} & \multicolumn{1}{c}{\textbf{Mean Runtime}} \\
\midrule
{\em Zerg}    & 11400.00   & 200                            & 99580                 & 59 & 11387.70 & 80   & 11400.00   & 11400.00   & 562\xspace \si{\ms}\\
{\em Protoss} & 4916.38 & 1620                           & \multicolumn{1}{c}{-} & 54 & 4907.70  & 1300 & 3445.21 & 4480.00    & 1200\xspace \si{\ms} \\
{\em Terran}  & 6632.73 & \multicolumn{1}{c}{3 h 19 min} & \multicolumn{1}{c}{-} & 53 & 6619.30  & 130  & 3035.73 & 5767.55 & 1390\xspace \si{\ms} \\
\bottomrule
\end{tabular}
\end{table*}
...
% minute and then collected for each run the runtime when it reached its highest DPS. 
